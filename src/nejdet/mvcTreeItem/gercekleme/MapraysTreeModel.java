...
public class MapraysTreeModel extends Observable{
	private DefaultTreeModel treeModel;
	private DefaultMutableTreeNode root;
	
	public MapraysTreeModel() {
		root = new DefaultMutableTreeNode();
		treeModel = new DefaultTreeModel(root);
	}
	
	public boolean addItem(MapraysTreeItemData data, String parentUID) {
...
//				System.out.println("Added Data : " + nextData.getUniqueId());
		...
		this.setChanged();
		this.notifyObservers(new nejdet.mvcTreeItem.arayuz.AddNotification(parentUID, data));
...
//	}
	...
	private void removeNodeAndChildren(DefaultMutableTreeNode node) {
	    ...
	    this.setChanged();
	    this.notifyObservers(new nejdet.mvcTreeItem.arayuz.DeleteNotification(null, (MapraysTreeItemData) node.getUserObject()));
	}
	
	
	
	public boolean updateItem(MapraysTreeItemData oldData, MapraysTreeItemData newData) {
	    boolean found = false;
	    ...
	    while (depthFirstEnumeration.hasMoreElements()) {
	        ...
	        if (nextData.getUniqueId().equals(oldData.getUniqueId())) {
	            ...
	            MapraysTreeItemData updatedData = new MapraysTreeItemData(newData.getUniqueId(), newData.getVisibleText(), newData.getMenuIcon(), newData.getRunAction());
	    ...
	    if (found) {
	        ...
	        this.notifyObservers(new nejdet.mvcTreeItem.arayuz.UpdateNotification(oldData, newData));
	    }
